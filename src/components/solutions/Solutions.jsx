  ...
  return (
    <div className={solutions} id={"solutions"}>
      <div className={product}>
        <StaticImage quality={90}  className={picture} src={"../../images/space_navigation.jpg"} alt={"3D Space Pathfinding"} />
        <div className={about}>
          ...
          <div className={description}>
            ...
            Space Pathfinding, which provides you with a drop-in solution for
